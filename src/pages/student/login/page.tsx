...
export default function StudentLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/auth/login?loginAs=student`, {
        method: 'POST',
      ...
      >
        ...
        <div className="w-full h-full flex items-center justify-center">
          ...
          <div className="text-center p-8 relative z-20">
            ...
            <h3 className="text-3xl font-bold text-white mb-2 font-display">Welcome Student</h3>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-[#1E293B] rounded-full flex items-center justify-center mx-auto mb-4 text-secondary shadow-lg shadow-primary/20">
              <img src="/sa-logo.png" alt="S&A Associates" className="h-12 object-contain" />
            </div>
            <div>
          ...
          {/* Sign In Heading */}
          <h1 className="text-3xl font-bold text-[#1E293B] text-center mb-8 font-display">Sign In</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <input type="hidden" name="loginAs" value="student" />
            {/* Email Field */}
            ...
            <div className="text-right">
              <Link to="#" className="text-secondary hover:text-[#E05e1F] text-sm font-medium transition-colors">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              Not registered yet?{" "}
              <Link to="/student/signup" className="text-secondary font-semibold hover:text-[#E05e1F] transition-colors">
                Create an Account
              </Link>
            </p>
          </div>
